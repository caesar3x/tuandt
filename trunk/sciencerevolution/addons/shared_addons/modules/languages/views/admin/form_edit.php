            ...
            <fieldset>
                <ul>
                    <li class="<?php echo alternator('', 'even'); ?>">
                        ...
                        <div class="input"><?php echo form_input('code', set_value('code', $code), 'class="width-15"'); ?></div>
                    </li>
                    <li class="<?php echo alternator('', 'even'); ?>">
                    ...
                    <li class="<?php echo alternator('', 'even'); ?>">
                        ...
                        <div class="input"><?php echo form_input('flag', set_value('flag', $flag), 'class="width-15"'); ?></div>
                    </li>
                </ul>
            </fieldset>
        </div>
