...
class Xls extends \BasicExcel\AbstractReader {
    ...
    public function __construct($file = '', $store_extended_info = true, $outputEncoding = '') {
        $this->_ole = new \BasicExcel\Reader\Ole( );
    ...
    function read($sFileName) {
        ...
        if ($res === false) {
            ...
            if ($this->_ole->error == 1) {
                // bad file
                throw new \BasicExcel\Exception('The filename ' . $sFileName . ' is not readable');
    ...
    function _getCellDetails($spos, $numValue, $column) {
        ...
        if ($type == 'date') {
            ...
            $dateinfo = \BasicExcel\Ole::gmgetdate($utcValue);
