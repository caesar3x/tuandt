            ...
            <fieldset>
                <ul>
                    ...
                    <li class="<?php echo alternator('', 'even'); ?>">
                        ...
                        <div class="input"><?php echo form_input('sub_header', set_value('sub_header', $sub_header), 'class="width-15"'); ?></div>
                    </li>
                    <li class="<?php echo alternator('', 'even'); ?>">
                        <label for="thumbnail"><?php echo lang('news:thumbnail'); ?> <span>*</span></label>
                        <div class="input"><?php echo form_input('thumbnail', set_value('thumbnail', $thumbnail), 'class="width-15"'); ?></div>
                    </li>
                    <li class="<?php echo alternator('', 'even'); ?>">
                        <label for="content"><?php echo lang('news:content'); ?> <span>*</span></label>
                        <div class="input"><?php echo form_input('content', set_value('content', $content), 'class="width-15"'); ?></div>
                    </li>
                </ul>
            </fieldset>
        </div>
