...
<div class="container">
    <div class="page-title row-fluid">
        ...
        <div class="span4">
            <a href="{{url:site}}signup/company" class="button large right" title="Search" ><span><?php echo lang('SIGN UP AS COMPANY')?></span></a>
        </div>
    </div>
    <div class="row-fluid">
        <div class="col-main span12">
            <div class="page-content">
                ...
                <div class="row-fluid">
                    <div class="arrow arrow16"><strong class="title-16"><?php echo lang('Show alert & other settings')?></strong></div>
                </div>
                <div class="row-fluid">
                    <div class="row-fluid">
                        <div class="span6">
                            <label><?php echo lang('Tax number')?></label>
                            <?php echo form_input(array('name' => 'tax_number','class' => 'input-text'),set_value('tax_number'),'required')?>
                        </div>
                        <div class="span2">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <?php echo form_dropdown('country',$countries,set_value('country'),'class="large" id="select-country" required')?>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span2">
